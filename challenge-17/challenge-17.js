...
console.log(text.replace(/Manuel Marques de Sousa/, 'Rafael Nogueira Silva'))
...
console.log(text.replace(/ brasileiro/, ' fluminense'))
...
console.log(
    text.replace(/O Centauro de Luvas/, function(frase) {
